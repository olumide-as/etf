    ...
    <div>
      <footer className="text-slate-50 bg-opacity-0 px-4 py-5 max-w-screen-xl mx-auto md:px-8">
            <div className="max-w-lg sm:mx-auto sm:text-center">
                ...
                A community owned ETF meme-based cryptocurrency. You can get some $ETF for free now!
                </p>
            </div>
            <ul className="items-center justify-center mt-8 space-y-5 sm:flex sm:space-x-4 sm:space-y-0">
                {
                    footerNavs.map((item, idx) => (
                        <li className="text-green-400 hover:text-green-500">
            ...
            <div className="m-4 ">
                    <ul className="flex items-center space-x-4 ">
                        <li className="w-10 h-10 border rounded-full flex items-center justify-center">
                            <a href="https://twitter.com/EatTheFud">
                        ...
                        <li className="w-10 h-10 border rounded-full flex items-center justify-center">
                            <a href="https://discord.com/invite/zx5NeQfHaC">
